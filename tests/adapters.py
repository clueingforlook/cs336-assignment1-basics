...
def run_swiglu(
    ...
    model.w_1.data = w1_weight
    model.w_2.data = w2_weight
    model.w_3.data = w3_weight
    return model(in_features)
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.runCausalMultiHeadSelfAttention import run_multihead_self_attention
